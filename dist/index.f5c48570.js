...
var _campagne23Json = require("./lib/campagne-23.json");
var _campagne23JsonDefault = parcelHelpers.interopDefault(_campagne23Json);
var _campagne24Json = require("./lib/campagne-24.json");
var _campagne24JsonDefault = parcelHelpers.interopDefault(_campagne24Json);
...
RANDOM.addEventListener("click", function(e) {
    ...
    if (FORM.classList.contains("campagne-23")) randomOutput((0, _campagne23JsonDefault.default));
    else if (FORM.classList.contains("campagne-24")) randomOutput((0, _campagne24JsonDefault.default));
});

},{"./lib/campagne-23.json":"4MvIN","./lib/campagne-24.json":"4i3SC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4MvIN":[function(require,module,exports) {
module.exports = JSON.parse('[{"min":180,"max":250,"value":215},{"min":55,"max":100,"value":70},{"min":35,"max":70,"value":50}]');

},{}],"4i3SC":[function(require,module,exports) {
module.exports = JSON.parse('[{"min":90,"max":160,"value":145},{"min":55,"max":100,"value":85},{"min":30,"max":70,"value":45}]');
...
},{}]},["bcmUh","8ZNvh"], "8ZNvh", "parcelRequire27dd")
